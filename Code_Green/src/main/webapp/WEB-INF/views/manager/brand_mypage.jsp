    ...
    <aside class="ps-drawer--mobile">
        ...
        <div class="ps-drawer__content">
            <ul class="menu">
								...
								<li><a class="active"  href="brand_mypage?manager_id=${sessionScope.sId }"><i class="icon-cog"></i>내브랜드정보</a></li>
            </ul>
        </div>
    </aside>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>기업 상세정보 </label>
                                            <input type="text"class="form-control" id="manager_info" name="manager_info"value="${brandInfo.manager_info }"readonly="readonly" />
                                        </div>
                                    </div>
                                    </div>
