       ...
       <table class="table ps-table">
                    ...
                    <hr>
                     ...
                     <c:forEach var="order" items="${orderList}" >
						    <tr>
						     <td><a href="location.href='order_detail?order_number=${order.sell_order_number}'"></a></td>
         		...
         		<div class="ps-form__submit text-center">
                         ...
                         <a href= "inventory_management?item_idx=${order.item_idx}"> <button class="ps-btn success"type="submit">재고수정</button></a>
                         <button class="ps-btn success"type="submit"onclick="inventory_management=${ItemInfo.item_idx }">상태변경</button>
