...
<!--  회원상세정보 조회		회원상세정보 조회	회원상세정보 조회	회원상세정보 조회	회원상세정보 조회	회원상세정보 조회	회원상세정보 조회	회원상세정보 조회-->
			    ...
			    <div class="input-form-backgroud row">
			      <div class="input-form col-md-12 mx-auto">
			        ...
			        <form class="validation-form" novalidate action="ad_member_Detail_Update" method="get">
			        
			          
			<!-- 이름 -->
			         <div class="mb-3">
			            <label for="email">이름</label>
			            <input type="text" class="form-control" id="name" value="${member.member_name }" readonly="readonly">
			          </div> 
