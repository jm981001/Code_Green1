...
<!--                     </form> -->
                ...
                <div class="header__right"><a class="header__site-link" href="ad_One_Board"><span>목록으로 돌아가기</span><i class="icon-exit-right"></i></a></div>
            </header>
...
<!-- 					<th scope="col">Handle</th> -->
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>작성일</td>
				      <fmt:parseDate var="dateString" value="${oneQnaInfo.qna_date }" pattern="yyyyMMdd" />	
