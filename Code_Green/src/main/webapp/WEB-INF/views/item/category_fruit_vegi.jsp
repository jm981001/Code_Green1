...
<head>
    ...
    <script type="text/javascript">
    	...
    	var sortItemList = function(value) {
    		...
    		if(value == "newDate"){
    			$('#fruitVegiList').show();
    			$('#reviewFruitVegiList').hide(); 
	        	$('#cheapFruitVegiList').hide();
	    		$('#expensiveFruitVegiList').hide();
    		} else if(value == "review") {
	    		$('#fruitVegiList').hide();
	    		$('#reviewFruitVegiList').show();  
	        	$('#cheapFruitVegiList').hide();
	    		$('#expensiveFruitVegiList').hide();
    		} else if(value == "cheap"){
	    		$('#fruitVegiList').hide();
	    		$('#reviewFruitVegiList').hide(); 
	        	$('#cheapFruitVegiList').show();
	    		$('#expensiveFruitVegiList').hide();
	    	} else {
	    		$('#fruitVegiList').hide(); 
	    		$('#reviewFruitVegiList').hide();
	        	$('#cheapFruitVegiList').hide();
	    		$('#expensiveFruitVegiList').show();
			}
    	};
            ...
            <div class="container">
                ...
                <div class="ps-section__wrapper">
                    ...
                    <div class="ps-section__right">
						<div id="category_h3">
						 ...
						 <nav class="ps-store-link">
							...
							<!-- 검색 기능 구현을 위한 form 태그 -->
								<form action="category_fruit_vegi" method="get">
                        ...
                        <div class="ps-shopping ps-tab-root" id="fruitVegiList">
                            <div class="ps-tabs">
...
<!-- --------------------------------------후기 많은순 (후기 많은순 페이징 필요)----------------------------------------------------- -->
                        ...
                        <div class="ps-shopping ps-tab-root" id="reviewFruitVegiList">
                             <div class="ps-tabs">
                                <div class="ps-tab active" id="tab-1">
                                    <div class="ps-shopping-product">
                                        <div class="row">
...
<!-- --------------------------------------낮은 가격순 (낮은 가격순 페이징 필요)----------------------------------------------------- -->
                        ...
                        <div class="ps-shopping ps-tab-root" id="cheapFruitVegiList">
                            <div class="ps-tabs">
                                <div class="ps-tab active" id="tab-1">
                                    <div class="ps-shopping-product">
                                        <div class="row">
...
<!-- -------------------------------------높은 가격순 (높은 가격순 페이징 필요)----------------------------------------------------- -->
                        ...
                        <div class="ps-shopping ps-tab-root" id="expensiveFruitVegiList">
                            <div class="ps-tabs">
                                <div class="ps-tab active" id="tab-1">
                                    <div class="ps-shopping-product">
                                        <div class="row">
...
<%--                                         		<c:forEach var="image" items="${imageList }"> --%>
		                    ...
		                    <div class="ps-pagination">
		                        <ul class="pagination">
		                            ...
		                            <li><%if(pageInfo.getPageNum() > pageInfo.getStartPage()) {%><a class="pageLink" href="category_fruit_vegi?pageNum=${pageInfo.pageNum - 1}&searchType=${searchType }&keyword=${keyword}&sort=${sort}"><%}%><i class="icon-chevron-left"></i>Prev</a></li>
		                            <c:forEach var="i" begin="${pageInfo.startPage }" end="${pageInfo.endPage }">
		                            	<c:choose>
		                            		<c:when test="${i eq pageInfo.pageNum }"><li class="active"><a class="pageLink" class="pageLink" href="#">${i }</a></li></c:when>
		                            		<c:otherwise><li><a class="pageLink" href="category_fruit_vegi?pageNum=${i }&searchType=${searchType }&keyword=${keyword}&sort=${sort}">${i }</a></li></c:otherwise>
		                            	</c:choose>
		                            </c:forEach>
		                            <li><%if(pageInfo.getPageNum() < pageInfo.getMaxPage()) {%><a class="pageLink" href="category_fruit_vegi?pageNum=${pageInfo.pageNum + 1}&searchType=${searchType }&keyword=${keyword}&sort=${sort}"><%}%>Next<i class="icon-chevron-right"></i></a></li>
		                        </ul>
		                    </div>
		                    <!-- 페이징 버튼들 끝 -->
