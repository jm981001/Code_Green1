        ...
        <section class="ps-store-list">
            <div class="container">
      			<aside class="ps-block--store-banner-newitemlist">
                	<!-- 브랜드 정보 및 대표이미지 넣을 곳 -->
                    <div class="ps-block__content bg--cover" data-background="/Code_Green/resources/img/new.jpg">
                    </div>
                </aside>
                        <!-- ---------------------------------------------- 신상품------------------------------------------------------------------- -->
					...
					<div class="container">
						<div class="ps-section__header">
							...
							<ul class="ps-section__links">
								<li><a href="ItemList.bo">신상품순 </a></li>
								<li><a href="ItemList_sales.bo">판매량순 </a></li>
								<li><a href="ItemList_cheap.bo">낮은 가격순</a></li>
								<li><a href="ItemList_ex.bo">높은 가격순</a></li>
							</ul>
						</div>
					</div>
				</div>
                                ...
                                <div class="ps-tab active" id="tab-1">
                                    <div class="ps-shopping-product">
                                        <div class="row">
                                        	...
                                        	<!-- 상품 1개당 시작 -->
                                        	<c:forEach var="item" items="${itemList_cheap }">
